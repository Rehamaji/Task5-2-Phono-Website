...
/*------------------Carsoul data--------------------*/
    ...
    fetch('https://dummyjson.com/products/category/smartphones')
      ...
      /*  .then(data =>console.log(data.products.title))
        .then(data =>console.log(data.products.rating))
        .then(data =>console.log(data.products.price))
        .then(data =>console.log(data.products.images));*/
